...
from network_ops_dashboard.inventory.models import Inventory, InventoryInterface, Platform
...
def inventory_discovery_results(request, job_id):
    ...
    return render(request, "network_ops_dashboard/inventory/discovery/results.html", {"job": job, "devices": devices})
